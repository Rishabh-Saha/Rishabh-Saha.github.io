...
// Query: *[_type == "navigation"] | order(order asc){  title,  href,  icon,  isExternal,  enabled}
...
// Source: ./components/PortfolioContent.tsx
// Variable: PORTFOLIO_NAVIGATION_QUERY
// Query: *[_type == "navigation"] | order(order asc){  title,  href,  icon,  isExternal,  enabled}
export type PORTFOLIO_NAVIGATION_QUERYResult = Array<{
  title: string | null;
  href: string | null;
  icon: string | null;
  isExternal: boolean | null;
...
// Variable: HERO_QUERY
// Query: *[_id == "singleton-profile"][0]{  firstName,  lastName,  headline,  headlineStaticText,  headlineAnimatedWords,  headlineAnimationDuration,  shortBio,  email,  phone,  location,  availability,  socialLinks,  yearsOfExperience,  profileImage,  resume {asset->{url}}}
...
declare module "@sanity/client" {
  interface SanityQueries {
    '*[_type == "navigation"] | order(order asc){\n  title,\n  href,\n  icon,\n  isExternal,\n  enabled\n}':
      ...
      | PORTFOLIO_NAVIGATION_QUERYResult;
